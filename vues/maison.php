...
<head>
	...
	<title>Ferme Saint Achaire | Maison de vie communautaire</title>
	<meta name="description" content="Découvrez la Ferme Saint Achaire, maison de vie communautaire. Accueil, hébergement et réinsertion sociale à travers notre activité de bois de chauffage.">
    ...
    <main>
		...
		<section class="contenu">
			<section class="zigzag">
				...
				<article>
					<h2>Aujourd'hui</h2>
					<p>Au jour d’aujourd’hui, c’est Etienne qui a récupéré les renes pour continuer sa mission. La ferme accueille en ce moment 18 personnes. Tout le monde a un droit au logement pour fructifier dans sa vie personnelle. Son activité annexe de bois accueille toujours quiconque cherche à s’occuper et garder aussi un lien social.</p>
				</article>
				<article>
					<h2>Et demain ?</h2>
